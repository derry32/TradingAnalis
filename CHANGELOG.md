...
- **Exit Engine Experiment #2 (EA):** Sistem *Break-Even* dan *Trailing Stop* disesuaikan ke jalan tengah (lebih agresif mengamankan profit dibanding Exp #1). Parameter di-freeze pada: `BE Trigger = 1.0R`, `BE Offset = +0.1R`, `Trailing Start = 1.5R`, dan `Trailing Gap = 0.8R`. Tujuannya agar profit 1R (setara 1x resiko) langsung diamankan tanpa menunggu terlalu lama.
